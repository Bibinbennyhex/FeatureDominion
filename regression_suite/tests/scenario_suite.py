...
def run_null_update_test(namespace: str = "main_null"):
    ...
    try:
        ...
        _assert_equal(row1["balance_am_history"][0], -1, "Case II sentinel preserved")
        _assert_equal(row2["balance_am_history"][0], -1, "Case I sentinel preserved")
...
def run_bulk_historical_load_test(namespace: str = "main_bulk"):
    ...
    try:
        ...
        _assert_equal(len(latest["balance_am_history"]), 72, "Bulk latest history length")
